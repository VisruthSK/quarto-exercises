...
See the extension in action. If you want to learn more about how to write the questions, read the [reference page](reference.qmd).

## Multiple Choice / Multiple Answer

### Minimal Single-Choice

::: {.exercise data-testid="mcq-single"}
...
::: {.exercise shuffle=true data-testid="mcq-multiple"}
...
::: {.exercise data-testid="mcq-feedback"}
...
::: {.exercise data-testid="mixed-inline-exercise"}
